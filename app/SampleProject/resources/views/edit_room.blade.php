...
@section('content')
    <div class="container">
        <div>
            <div class="card">
                <div class="card-header">{{ __('ルーム編集') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{route('edit__', [$room->id])}}">
                        @csrf
                        ...
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="room_name" type="text" class="form-control @error('room_name') is-invalid @enderror" name="room_name" value="{{ $room->room_name }}" autocomplete="room_name" autofocus>
                        ...
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="created_name" type="text" class="form-control @error('name') is-invalid @enderror" name="created_name" value="<?php $user = Auth::user(); ?>{{ $user->name }}" autocomplete="created_name" autofocus readonly>
